...
function Checklist() {
    ...
    return(
        <div className="ChecklistPanel"> <NavigationBar></NavigationBar>
            <div className="Checklist">
                ...
                <OrderedBoxes buttonText="4 )" panelText="Is the conveyor belt empty?" id={4} currentBox={currentId} navigateToButtonText="No" nextStepButtonText="Yes" buttonFunction={() => navigate("/problems")}/>
            </div>
